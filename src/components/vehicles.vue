                  ...
                  <div class="col-md-12 m-0 p-0">
                    ...
                    <div class="col-md-12 py-3">
                        ...
                        <div class="row mt-4 p-0">
                            ...
                            <div class="col-md-2 col-6 text-center text-left">
                            ...
                            <div class="col-md-3 col-6 text-center text-left mb-3">
                                    <img src="../assets/lendbox.jpg" width="100%">   
                            </div>
                            <div class="col-md-2 col-6 text-center text-left mb-3">
                                    <img src="../assets/fincorp.png" width="100%">   
                            </div>
                        </div>
                    </div>
