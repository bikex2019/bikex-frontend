...
<div class="bikes">              
    ...
    <div class="col-md-10 py-2" style="margin:0 auto">
         <div class="row pl-2 pr-2" >
                <div class="col-4 col-md-4 col-lg-3 pt-2 pr-1 pl-1" v-for="(image, index) in commuters" :key="index">  
                    <div class="moterbike"> 
    ...
    <div >
        <!-- <div id="overlay" class="loading text-center mb-4" style="min-height:200px" v-if="loadingPage">
